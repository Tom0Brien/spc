"""G1 Pass (augmented) MPC example using SPC C++ backend.

Uses the G1PassAugmented task with CEM optimization. The control vector is
extended to 15 dims:
...
Usage: python3 examples/g1_pass_augmented.py [--no_policy]
"""
...
def main():
    ...
    task = spc_py.create_task("G1PassAugmented", env, task_params)
