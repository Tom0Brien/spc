"""Booster K1 Navigation MPC example using SPC C++ backend.

Uses the K1Navigation task with CEM optimization to navigate a Booster K1
...
def main():
    ...
    model_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../models/k1/scene_navigation.xml"))
    ...
    task = spc_py.create_task("K1Navigation", env, task_params)
