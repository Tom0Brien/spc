"""G1 Soccer (augmented) MPC example using SPC C++ backend.

Uses the G1SoccerAugmented task with CEM optimization. The control vector is
extended to 15 dims:
...
Usage: python3 examples/run_g1_soccer_augmented.py [--no_policy]
"""
...
def main():
    ...
    task = spc_py.create_task("G1SoccerAugmented", env, task_params)
