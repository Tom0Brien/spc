...
PYBIND11_MODULE(spc_py, m) {
    ...
    py::class_<spc::algs::CEMConfig>(m, "CEMConfig")
        ...
        .def_readwrite("phase_dims", &spc::algs::CEMConfig::phase_dims)
        .def_readwrite("phase_freq", &spc::algs::CEMConfig::phase_freq)
        .def_readwrite("seed", &spc::algs::CEMConfig::seed)
